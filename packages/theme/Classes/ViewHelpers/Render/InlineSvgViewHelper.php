...
namespace Workshop\Theme\ViewHelpers\Render;
...
use Workshop\Theme\Service\Svg\CustomAttributes;
use Workshop\Theme\Service\Svg\CustomTags;
 ...
 *
 * Notes
 * This ViewHelper renders Inline Svg from a given SVG File. To make the SVG accessible,
 * you can add an ID and a TITLE to the produced inline svg. The original title will always be removed.
...
class InlineSvgViewHelper extends AbstractViewHelper
{
     ...
     *
     * @return string
     * @throws \DOMException|\TYPO3\CMS\Core\Exception
     */
    protected static function getInlineSvg(string $source, array $arguments): string
    {
    ...
    /**
     * Copied from core due to missing possibility to remove xml tag
     *
